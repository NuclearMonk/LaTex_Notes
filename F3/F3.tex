...
\begin{center}
    \begin{tikzpicture}
        ...
        \fill [red](O) circle [radius = 0.1] node[below] {q};
        
        \draw [->] (O)+(0,1) -- (0,2) node [midway,left] {$\vec{n}$};
        \draw [->] (O)+(0,-1) -- (0,-2)node [midway,right] {$\vec{n}$};
        \draw [->] (O)+(1,0) -- (2,0)node [midway,above] {$\vec{n}$};
        \draw [->] (O)+(-1,0) -- (-2,0)node [midway,below] {$\vec{n}$};

        \draw [blue,->] (O)+(0.2,0.2) -- (2,2);
        \draw [blue,->] (O)+(-0.2,-0.2) -- (-2,-2);
        \draw [blue,->] (O)+(0.2,-0.2) -- (2,-2);
        \draw [blue,->] (O)+(-0.2,0.2) -- (-2,2);
...
\begin{center}
    \begin{tikzpicture}
        \coordinate (O) at (0,0);
        \draw (O) circle [radius=1];
        \fill [red](O) circle [radius = 0.5] node[below] {q};
        \draw [green](O) circle [radius=2] node [below = 30,right = 50] {Superfície de Gauss esférica};
        \draw [green,->] (1.73,1) -- (3.46,2) node [below] {$ \vec{n} $}; 
        \draw [blue,->] (O) -- (2,2) node [right] {$\vec{E}$};
        \draw [blue,->] (O) -- (-2,-2);
        \draw [blue,->] (O) -- (2,-2);
        \draw [blue,->] (O) -- (-2,2);
        \draw [blue,->] (O) -- (0,2.75);
        ...
        \coordinate (I) at (8,1);
        \draw (O2) circle [radius=1] node[below=30] {porquê radial?};
        \draw (O2) -- (I);
        \draw [red,Circle-,dotted](O2) + (0.5,0) -- (I);
        \draw [red,<-] (I) + (-0.25,1) -- (I);
        \draw [red,Circle- ,dotted](O2) + (-0.5,0) -- (I);
        \draw [red,<-] (I) + (0.25,1) -- (I);
        \draw [red,<-] (I) + (0,2) -- (I);
